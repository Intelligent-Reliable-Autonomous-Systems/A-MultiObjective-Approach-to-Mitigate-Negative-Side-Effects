...
private:
    ...
    /* If set to True, solves only the first level and generates filtered actions */
    bool solveL0_;
...
public:
     ...
     */
    MOLAOStarSolver(mlmobj::MOProblem* problem,  bool solveL0 = false, double epsilon = 1.0e-6,
                    int timeLimit = 1000000, bool useLC = false)
        : problem_(problem),  solveL0_(solveL0), epsilon_(epsilon),
