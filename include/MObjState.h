...
protected:
    ...
    std::list<mlcore::Action*> filteredActions_;
    /* Stores all actions with max Q values for each state */
    std::list<mlcore::Action*> BestActions_;
...
public:
    ...
    /** Returns the allowed actions for the next lexi level**/
     std::list<mlcore::Action*> & filteredActions() { return  filteredActions_;}

     std::list<mlcore::Action*> & BestActions() { return BestActions_;}

     void setFilteredActions(std::list<mlcore::Action*> a) {filteredActions_ =  a;}

     void setBestActions(std::list<mlcore::Action*> a) {BestActions_ =  a;}
